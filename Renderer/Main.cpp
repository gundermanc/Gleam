...
int main(int argc, char *argv[])
{
    ...
    auto segment0 = std::shared_ptr<AbstractControl>(
        new TextSegment(std::string("Hello there"), 10, colors::Black, colors::White, 0, 0, 50, 50));

    auto segment1 = std::shared_ptr<AbstractControl>(
        new TextSegment(std::string("This is an.."), 20, colors::Black, colors::White, 50, 50, 50, 50));

    auto segment2 = std::shared_ptr<AbstractControl>(
        new TextSegment(std::string("Untitled Christian Gunderman project"), 30, colors::Black, colors::White, 80, 80, 50, 50));
